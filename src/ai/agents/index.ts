...
import { knowledgeAnswerer } from "./knowledge-answerer";
...
const list: AnyAgent[] = [investigationExtractor, permitAdvisor, documentAuthor, calculatorAgent, plannerAgent, tenderDesigner, tenderAuthor, nviResponder, bidChecker, bidAssessor, sessionSynthesizer, awardAdvisor, knowledgeAnswerer];
